...
public class RichTextAreaActionComponent extends ActionComponent implements Reflection
{
private static final Class<?> DEFAULT_EVENT_TYPE = BlurHandler.class;
	...
	richTextArea=(RichTextArea)actionBinding.getComponent();
	...
	public void bind() {
		...
		if(eventType==ClickHandler.class){
			...
			richTextArea.addClickHandler(clickHandler);
		}
		...
		richTextArea.addDoubleClickHandler(doubleClickHandler);	
		}
		...
		focusHandler=new FocusHandler() {
			...
			richTextArea.addFocusHandler(focusHandler);
		}
		...
		if(eventType==GestureChangeHandler.class){
				...
				richTextArea.addGestureChangeHandler(gestureChangeHandler);
		...
		if(eventType==KeyDownHandler.class){
			...
			richTextArea.addKeyDownHandler(keyDownHandler);
		}
        ...
        if(eventType==KeyUpHandler.class){
			...
			richTextArea.addKeyUpHandler(keyUpHandler);
		}
        ...
        if(eventType==MouseDownHandler.class){
			...
			richTextArea.addMouseDownHandler(mouseDownHandler);
		}
		...
		mouseMoveHandler= new MouseMoveHandler() {
			...
			richTextArea.addMouseMoveHandler(mouseMoveHandler);
		}
        ...
        if(eventType==KeyUpHandler.class){
	       mouseOutHandler= new MouseOutHandler() {
			...
			richTextArea.addMouseOutHandler(mouseOutHandler);
		}
        ...
        if(eventType==MouseOverHandler.class){
			...
			richTextArea.addMouseOverHandler(mouseOverHandler);
		}
		...
		mouseUpHandler= new MouseUpHandler() {
			...
			richTextArea.addMouseUpHandler(mouseUpHandler);
		}
		...
		mouseWheelHandler= new MouseWheelHandler() {
			...
			richTextArea.addMouseWheelHandler(mouseWheelHandler);
		}
        ...
        if(eventType==KeyUpHandler.class){
		   ...
		   touchCancelHandler = new TouchCancelHandler() {
			...
			richTextArea.addTouchCancelHandler(touchCancelHandler);
		}
        ...
        if(eventType==TouchEndHandler.class){
			...
			richTextArea.addTouchEndHandler(touchEndHandler);
		}
        ...
        if(eventType==KeyUpHandler.class){
			...
			richTextArea.addTouchMoveHandler(touchMoveHandler);
		}
		...
		touchStartHandler= new TouchStartHandler() {
        	...
        	richTextArea.addTouchStartHandler(touchStartHandler);
		}
