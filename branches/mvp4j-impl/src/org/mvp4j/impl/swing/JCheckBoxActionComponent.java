...
public class JCheckBoxActionComponent extends ActionComponent{
	...
	public void bind() {
		...
		jcheckBox.addKeyListener(keyListener);
			...
			jcheckBox.addComponentListener(componentListener);
		}
			...
			jcheckBox.addContainerListener(containerListener);
		}
			...
			jcheckBox.addFocusListener(focusListener);
		}
			...
			jcheckBox.addHierarchyBoundsListener(hierarchyBoundsListener);
		}
			...
			jcheckBox.addHierarchyListener(hierarchyListener);
		}
			...
			jcheckBox.addInputMethodListener(inputMethodListener);
		}
			...
			jcheckBox.addMouseMotionListener(mouseMotionListener);
		}
			...
			jcheckBox.addMouseWheelListener(mouseWheelListener);
		}
			...
			jcheckBox.addPropertyChangeListener(propertyChangeListener);
		}
		else
