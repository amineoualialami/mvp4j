...
public class RadioButtonActionComponent extends ActionComponent implements Reflection{

	private static final Class<?> DEFAULT_EVENT_TYPE = FocusHandler.class;
	...
	public void init(ActionBinding actionBinding) {
	   ...
	   radioButton=(RadioButton)actionBinding.getComponent();
	}
