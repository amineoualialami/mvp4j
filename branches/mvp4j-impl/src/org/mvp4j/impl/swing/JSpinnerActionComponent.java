...
public class JSpinnerActionComponent extends ActionComponent{
	...
	public void bind() {
		...
		if(eventType==ChangeListener.class){
			if(eventAction.equals("")){
				eventAction="stateChanged";
			}
			changeListener=new ChangeListener() {
			
					@Override
					public void stateChanged(ChangeEvent e) {
						if(eventAction.equals("stateChanged")){
			...
			jspinner.addMouseListener(mouseListener);
		...
		jspinner.addKeyListener(keyListener);
			...
			jspinner.addComponentListener(componentListener);
		}
			...
			jspinner.addAncestorListener(ancestorListener);
		}
			...
			jspinner.addContainerListener(containerListener);
		}
			...
			jspinner.addFocusListener(focusListener);
		}
			...
			jspinner.addHierarchyBoundsListener(hierarchyBoundsListener);
		}
			...
			jspinner.addHierarchyListener(hierarchyListener);
		}
			...
			jspinner.addInputMethodListener(inputMethodListener);
		}
			...
			jspinner.addMouseMotionListener(mouseMotionListener);
		}
			...
			jspinner.addPropertyChangeListener(propertyChangeListener);
		}
		else
